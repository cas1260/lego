...
Begin VB.Form frmMain 
   ...
   ClientTop       =   1875
   ClientWidth     =   10215
   Icon            =   "codeHighlightTest1.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   5460
   ScaleWidth      =   10215
   Begin Lego.CodeHighlight CodeHighlight1 
      Height          =   2715
      Left            =   990
      TabIndex        =   5
      Top             =   1530
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "codeHighlightTest1.frx":000C
            Key             =   "copy"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "codeHighlightTest1.frx":050E
            Key             =   "cut"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "codeHighlightTest1.frx":0A10
            Key             =   "paste"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "codeHighlightTest1.frx":0F12
            Key             =   "find"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "codeHighlightTest1.frx":1414
            Key             =   "open"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "codeHighlightTest1.frx":1916
            Key             =   "save"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "codeHighlightTest1.frx":1E18
            Key             =   "new"
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.Toolbar tbMain 
      ...
      Begin VB.ComboBox cboHighlightOn 
         Height          =   315
         ItemData        =   "codeHighlightTest1.frx":231A
         Left            =   7680
         List            =   "codeHighlightTest1.frx":2324
